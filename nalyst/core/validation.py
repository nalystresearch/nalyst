...
def duplicate(estimator: Any) -> Any:
    """Create a deep copy of an estimator.

    Calibration and cross-validation helpers rely on cloning base estimators
    before fitting; this wrapper keeps Nalyst self-contained without adding
    extra dependencies. It uses ``copy.deepcopy`` to replicate the estimator
    state.
    """
